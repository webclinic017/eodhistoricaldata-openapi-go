...
// string period (name or id) of the historyquotes
func (r ApiListHistoryQuotesRequest) Period(period string) ApiListHistoryQuotesRequest {
	r.period = &period
	return r
}

// string fmt (name or id) of the historyquotes
func (r ApiListHistoryQuotesRequest) Fmt(fmt string) ApiListHistoryQuotesRequest {
	r.fmt = &fmt
	return r
}

// string filter (name or id) of the historyquotes
func (r ApiListHistoryQuotesRequest) Filter(filter string) ApiListHistoryQuotesRequest {
	r.filter = &filter
	return r
}

// string order (name or id) of the historyquotes
func (r ApiListHistoryQuotesRequest) Order(order string) ApiListHistoryQuotesRequest {
	r.order = &order
	return r
}

// string from (name or id) of the historyquotes
func (r ApiListHistoryQuotesRequest) From(from string) ApiListHistoryQuotesRequest {
	r.from = &from
	return r
}

// string to (name or id) of the historyquotes
...
// string fmt (name or id) of the shortsquotes
